# Spec: parallel-keyword-scraping

## Purpose

This spec defines the behavior of keyword-parallel scraping in the Mercari scraper. The scraper processes multiple keywords concurrently using bounded parallelism, condition-based modal detection, and accurate result aggregation across parallel runs.
